...
impl PsarState {
    ...
    pub fn from_json(json: String) -> Result<PsarState, JsError> {
...
/// Run the PSAR indicator. Returns `[outputs, state]` as a JS array.
/// `inputs`: `[[high, low]]`   `options`: `[accel_factor_step, accel_factor_max]`
#[wasm_bindgen(js_name = "psarIndicator")]
...
#[wasm_bindgen(js_name = "psarMinDataAccuracy")]
