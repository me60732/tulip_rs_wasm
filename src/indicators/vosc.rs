...
impl VoscState {
    ...
    pub fn from_json(json: String) -> Result<VoscState, JsError> {
...
/// Run the VOSC indicator. Returns `[outputs, state]` as a JS array.
/// `inputs`: `[[volume]]`   `options`: `[short_period, long_period]`
#[wasm_bindgen(js_name = "voscIndicator")]
...
#[wasm_bindgen(js_name = "voscMinDataAccuracy")]
